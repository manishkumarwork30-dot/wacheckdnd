...
function extractHeaderMediaMessage(message) {
  ...
  for (const header of headers) {
    ...
    for (const [field, type] of headerMapping) {
      const node2 = header[field];
      if (node2) {
        return { mediaMessage: node2, mediaType: type };
      }
    }
  }
  return null;
...
var BaileysConnection = class {
  ...
  socket;
  clearAuthState;
  clearOnlinePresenceTimeout = null;
  reconnectCount = 0;
  connectionReplacedTimestamps = [];
  isDiscarded = false;
  _inFlightWebhooks = 0;
  leaseEpoch = null;
  lastQRDataUrl = null;
  ...
  _apiKeyHash;
  groupActivityMap = /* @__PURE__ */ new Map();
  groupActivityInterval = null;
  ...
  reachoutTimelockFetchInFlight = false;
  lastReachoutTimelockFetchAt = 0;
...
var BaileysConnectionsHandler = class {
  ...
  drainingWebhooks = /* @__PURE__ */ new Set();
  createConnection;
...
var ClusterCoordinator = class {
  ...
  firstSeenUnleasedAt = /* @__PURE__ */ new Map();
  ...
  lastRebalanceReleaseAt = Number.NEGATIVE_INFINITY;
  ...
  heldLeaseEpochs = /* @__PURE__ */ new Map();
...
var connectionsController = new Elysia3({
  ...
  "",
  () => {
    return { data: baileys_default.getActivePhoneNumbers() };
  },
  {
    detail: {
...
<div class="container">
  <!-- Header -->
  <header>
    <h1>\u{1F7E2} Baileys WhatsApp Gateway</h1>
        ...
        activePhoneNumbers.forEach(phone => {
          ...
          item.innerHTML = \`
            <div class="session-details">
              ...
              <span class="session-status">\u{1F7E2} Connected & Active</span>
            </div>
